...
// paid amount. Create suitable methods to take and display the information with
// a clause that if amount paid is greater than 20000 then a discount of 5%
// given else no discount is granted.
